  ...
  inputs.forEach((input) => {
    ...
    if (label) {
      ...
      const type = inputElement
        ? inputElement.type || inputElement.tagName.toLowerCase()
        : "";
      ...
      // Placeholder text
      const placeholder = inputElement
        ? type === "textarea"
...
select.addEventListener("click", function () {
  const newDiv = document.createElement("div");
  newDiv.classList.add("formInput", "children");
  newDiv.setAttribute("draggable", true);
  newDiv.innerHTML = `
    <div class="inputInfo ">
...
const parent = document.querySelector(".mainP");
