...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// // Additional functionality Load form data from localStorage on page load
...
//                     </div>
//                 </div>
//                 <${data.type === 'select' ? 'select' : 'input'} 
//                     class="formInput formCommon ${data.type === 'select' ? 'select-info' : ''}"
//                     ${data.type === 'select' ? 'multiple' : ''}
//                 >
//                     ${data.options ? data.options.map(option => `<option value="${option}">${option}</option>`).join('') : ''}
//                 </${data.type === 'select' ? 'select' : 'input'}>
//             `;
//             newDiv.querySelector('.formInput').value = data.value;
...
//         const formData = Array.from(document.querySelectorAll('.formInput')).map(input => ({
//             id: input.id,
//             type: input.querySelector('input, select, textarea').type,
//             label: input.querySelector('label').textContent,
//             value: input.querySelector('input, select, textarea').value
//         }));
//         updateLocalStorage(formData);
//     });
// });
